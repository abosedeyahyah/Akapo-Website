      ...
      <div className="">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
            <div className="text-center">
              ...
              <p className="mt-2 text-base md:text-lg lg:text-xl max-w-xl">Years of Service</p>
              <p className="mt-2 text-base md:text-lg lg:text-xl max-w-xl">Providing reliable financial solutions</p>
            </div>
            <div className="text-center">
              <h4 className="text-4xl font-bold text-[#00A874]">1000+</h4>
              <p className="mt-2 text-base md:text-lg lg:text-xl max-w-xl">Happy Members</p>
              <p className="mt-2 text-base md:text-lg lg:text-xl max-w-xl">Helping members achieve their financial goals</p>
            </div>
            <div className="text-center">
              <h4 className="text-4xl font-bold text-[#00A874]">100M+</h4>
              <p className="mt-2 text-base md:text-lg lg:text-xl max-w-xl">Save Funds</p>
              <p className="mt-2 text-base md:text-lg lg:text-xl max-w-xl">Helping members achieve their financial goals</p>
            </div>
          </div>
        </div>
