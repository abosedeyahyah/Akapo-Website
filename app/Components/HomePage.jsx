          ...
          <div className="container mx-auto ">
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/2 lg:pl-8 lg:mt-20">
                <h1 className="mb-4 text-3xl md:text-4xl lg:text-5xl Montserrat font-medium">
                  Welcome to
                </h1>
                <h1 className="mb-4 text-3xl md:text-4xl lg:text-5xl Montserrat font-medium">
                  {" "}
                ...
                <div className="mt-8 flex space-y-4 md:space-y-0 md:space-x-4">
                  ...
                  <Link
                    href="#chat"
                    className="text-[#00A874] bg-[#F2F7F4] px-6 py-3 rounded flex items-center gap-2 text-sm md:text-base lg:text-lg"
                  >
                    Learn more
                    <img
          ...
          <div className="px-8 bg-white py-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex">
                ...
                <div className="px-3">
                  <h3 className="text-lg md:text-2xl max-w-xl text-black font-medium">
                    Happy Client
                  </h3>
                  <p className="">
